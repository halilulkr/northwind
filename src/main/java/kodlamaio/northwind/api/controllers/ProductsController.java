...
public class ProductsController {
	...
	@PostMapping("/add")
	public Result add(@RequestBody Product product) { //RequestBody kullanıcının girdiği değerleri body den al demek.
		return this.productService.add(product);
	}
	
	@GetMapping("/getbyproductname")
	public DataResult<Product> getByProductName(@RequestParam String productName) { //RequestParam kullanıcının girdiği değerler arasından productName parametresini bul ve kullan demek.
